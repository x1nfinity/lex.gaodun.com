...
module.exports = {
  ...
  "react/jsx-max-props-per-line": ["error", { maximum: 3, when: "multiline" }], // 限制JSX中单行上的props的最大数量 3
  ...
  "react/jsx-uses-react": "off", // Prevent React to be incorrectly marked as unused 防止反应被错误地标记为未使用
  ...
  "react/no-string-refs": "warn", // ref 直接string  ref="xxx"
  "react/no-unknown-property": "off", //防止使用未知的DOM属性
  "react/react-in-jsx-scope": "off", // JSX 必须import React
  ...
  "react/jsx-filename-extension": ["error", { extensions: [".jsx", ".tsx", ".js", "ts"] }], // 只有jsx文件 返回 JSX return <div>xxx</div>
  ...
  "react/jsx-no-comment-textnodes": "off", //  <div>// empty div</div>  <div>  /* empty div */  </div>
  ...
  // "react/jsx-indent": [2, 4, { checkAttributes: true }], // 暂时注释掉 异常报错
  "react/jsx-indent-props": ["error", 4], //验证JSX中的props缩进
  "react/jsx-key": "error", //在数组或迭代器中验证JSX具有key属性
  "react/jsx-boolean-value": "off", //在JSX中强制布尔属性符号
  ...
  "react/jsx-props-no-multi-spaces": "error", //禁止内联JSX道具之间的多个空格
};

// ----------------------- 以下为更严格的规范 ， 可当做 注释文档查看 -----------------------
// module.exports = {
//   /**
